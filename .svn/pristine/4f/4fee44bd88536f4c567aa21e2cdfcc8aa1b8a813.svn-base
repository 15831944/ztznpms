...
namespace ztznpms.DAL
{
    class DataOperate
    {
        ...
        public DataOperate()
        {
            ...
            //获取登录用户
            string strUserID = ReadFile.GetIniFileString("DataBase", "UserID", "", Application.StartupPath + "\\Express.ini");
            //获取登录密码
            string strPwd = ReadFile.GetIniFileString("DataBase", "Pwd", "", Application.StartupPath + "\\Express.ini");
            //数据库连接字符串
